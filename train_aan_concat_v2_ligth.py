...
class Encoder(torch.nn.Module):
  def __init__(self):
    ...
    self.encoder = torch.nn.Sequential(
                                       ...
                                       torch.nn.Conv2d(32, 24, kernel_size=3, stride=1),
                                       torch.nn.LeakyReLU(0.2, inplace=True),
                                       torch.nn.BatchNorm2d(24),
                                       torch.nn.Dropout(0.3),
                                       torch.nn.Conv2d(64, 16, kernel_size=3, stride=1),
                                       torch.nn.LeakyReLU(0.2, inplace=True),
                                       torch.nn.BatchNorm2d(16),
                                       torch.nn.Dropout(0.3),
                                       torch.nn.Conv2d(128, 8, kernel_size=3, stride=1),
                                       torch.nn.LeakyReLU(0.2, inplace=True),
                                       torch.nn.BatchNorm2d(8),
                                       torch.nn.Dropout(0.3),
                                       torch.nn.Conv2d(256, 4, kernel_size=3, stride=1),
                                       torch.nn.LeakyReLU(0.2, inplace=True),
                                       torch.nn.BatchNorm2d(4),
                                       torch.nn.Dropout(0.3),
                                       torch.nn.Conv2d(512, 2, kernel_size=3, stride=1),
                                       torch.nn.LeakyReLU(0.2, inplace=True),
...
class Decoder(torch.nn.Module):
  def __init__(self):
    ...
    self.decoder = torch.nn.Sequential(
                                    #UnFlatten(),
                                    torch.nn.ConvTranspose2d(2, 512, kernel_size=3, stride=1),
                                    torch.nn.ReLU(),
                                    torch.nn.BatchNorm2d(2),
                                    torch.nn.Dropout(0.3),
                                    torch.nn.ConvTranspose2d(4, 256, kernel_size=3, stride=1),
                                    torch.nn.ReLU(),
                                    torch.nn.BatchNorm2d(4),
                                    torch.nn.Dropout(0.3),
                                    torch.nn.ConvTranspose2d(8, 128, kernel_size=3, stride=1),
                                    torch.nn.ReLU(),
                                    torch.nn.BatchNorm2d(8),
                                    torch.nn.Dropout(0.3),
                                    torch.nn.ConvTranspose2d(16, 64, kernel_size=3, stride=1),
                                    torch.nn.ReLU(),
                                    torch.nn.BatchNorm2d(16),
                                    torch.nn.Dropout(0.3),
                                    torch.nn.ConvTranspose2d(32, 32, kernel_size=3, stride=1),
                                    torch.nn.ReLU(),
                                    torch.nn.BatchNorm2d(32),
                                    torch.nn.Dropout(0.3),
